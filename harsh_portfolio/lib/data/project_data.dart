...
class ProjectData {
  static const List<ProjectModel> projects = [
    ProjectModel(
      id: 'bounceup',
      title: 'BounceUp',
      subtitle: 'Arcade Paddle Ball Game - iOS & Android',
      domain: 'Gaming',
      overview:
          'A production-ready arcade paddle ball game built with Flutter and Flame Engine. Features single-player and local two-player modes with neon visuals, arcade sound effects, and haptic feedback. Published on the App Store and Play Store - completely offline, ad-free, with no in-app purchases.',
      techStack: [
        'Flutter',
        'Dart',
        'Flame Engine',
      ...
      features: [
        'Single-player mode with 3 lives, progressive ball speed, and personal best tracking',
        'Local two-player mode with simultaneous multi-touch on a single device',
        'Neon dark theme with glowing visual effects and smooth animations',
        'Arcade sound effects for paddle hits, wall bounces, life lost, and win/lose',
        'Haptic feedback on paddle interactions for tactile gameplay',
        'Persistent game history stored locally with Isar database',
        'Winner celebration with confetti fountain animation',
        'Responsive design for phones and tablets in portrait and landscape',
      ],
      architectureHighlights: [
        'Flame Engine game loop with custom Ball, Paddle, and Wall components',
        'Riverpod AsyncNotifier for state management across game and UI layers',
        'Isar NoSQL database for persistent game history and settings',
        'Dedicated drag zones for two-player multi-touch without conflict',
        'GoRouter for declarative navigation between menu, game, and history screens',
        'Sound effect manager with pooled audio for low-latency playback',
      ],
      technicalChallenges: [
        'Implementing accurate ball physics with angle-based paddle deflection',
        'Supporting simultaneous multi-touch for two-player mode without input interference',
        'Achieving consistent 60fps gameplay across diverse device hardware',
        'Designing responsive layouts that adapt game area for phones and tablets',
        'Managing audio lifecycle to prevent memory leaks during rapid sound playback',
      ],
      keyDeliverables: [
        'Published on Apple App Store and Google Play Store',
        'Single and two-player arcade game with progressive difficulty',
        'Persistent scoring system with game history',
  ...
  static const Map<String, List<String>> technologyGroups = {
    ...
    'Gaming': ['Flame Engine', 'Flame Audio'],
    'Database': ['SQL Server', 'Supabase', 'SQLite', 'Isar DB'],
